...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (376713,4014781,252477,439847,42873157,436430,432923,435959,439040,42872434)and invalid_reason is null
...
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (260841,436519,4071732,4345688,443752,4174299,380113)and invalid_reason is null
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
